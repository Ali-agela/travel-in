                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        CustomTitle(
                            ...
                            fontSize: 16,
                            color:
                                darkModeConsumer.isDark ? white : Colors.black)
                      ],
                    ),
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                            ...
                            children: [
                              TextFilterRow(
                                subtitle: AppLocalizations.of(context)!.tourism,
                                onTap: () {},
                              ),
                              SizedBox(
                                width: 8,
                              ...
                              TextFilterRow(
                                subtitle:
                                    AppLocalizations.of(context)!.deserttrips,
                                onTap: () {},
                              ),
                              SizedBox(
                                width: 8,
                              ...
                              TextFilterRow(
                                subtitle:
                                    AppLocalizations.of(context)!.seatrips,
                                onTap: () {},
                              ),
                              SizedBox(
                                width: 8,
                    ...
                    Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                            ...
                            children: [
                              TextFilterRow(
                                subtitle: AppLocalizations.of(context)!.family,
                                onTap: () {},
                              ),
                              SizedBox(
                                width: 8,
                              ...
                              TextFilterRow(
                                subtitle: AppLocalizations.of(context)!.youth,
                                onTap: () {},
                              ),
                              SizedBox(
                                width: 8,
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          Checkboxes(
                              subtitle: AppLocalizations.of(context)!.tripoli),
                          Checkboxes(
                              subtitle: AppLocalizations.of(context)!.benghazi),
                          Checkboxes(
                              subtitle:
                                  AppLocalizations.of(context)!.rasalhilal),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        CustomTitle(
                          title: AppLocalizations.of(context)!.bookingdate,
                          fontSize: 16,
                        )
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        CustomTitle(
                          title: AppLocalizations.of(context)!.numberofrooms,
                          fontSize: 16,
                        )
                      ],
                    ),

          ...
          return MaterialApp(
              ...
              theme: ThemeData(
                ...
                tabBarTheme: TabBarTheme(
                    ...
                    labelColor:
                        darkModeConsumer.isDark ? lightgrey : greycolor),
...
class _ScreenRouterState extends State<ScreenRouter> {
  ...
  void initState() {
    ...
    Provider.of<AuthenticationProvider>(context, listen: false).isFirst();
  ...
  Widget build(BuildContext context) {
    return Consumer<AuthenticationProvider>(
      ...
      return authConsumer.isLoading
          ? SizedBox()
          : authConsumer.isFistTime!
              ? Onboarding1()
              : authConsumer.isAuthed!
                  ? MainNavigator()
                  : LogInScreen();
    });
  }
